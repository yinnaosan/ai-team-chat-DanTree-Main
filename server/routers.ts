...
%%DELIVERABLE%%
{
  ...
  "confidence": "high|medium|low",
  "key_evidence": ["多头核心理由1（必须是分析性观点，如'AI算力需求持续扩张推动数据中心收入增长'，禁止直接引用原始数据如'PE=35.8'）", "多头核心理由2（不同维度：业务/技术/市场/竞争四选一）"],
  "reasoning": ["推理链1", "推理链2"],
  "counterarguments": [
    "反驳论点1（必须具体，含数据或逻辑，不得为空）",
    "反驳论点2（与论点1不同维度：估值/业务/宏观/情绪四选一）",
    "反驳论点3（最强反驳：如果只有一个理由能推翻本结论，是什么）"
  ],
